...
@Mod("craft_no_taizai")
public class CraftNoTaizaiMod {
	public static final Logger LOGGER = LogManager.getLogger(CraftNoTaizaiMod.class);
	public static final String MODID = "craft_no_taizai";

	public CraftNoTaizaiMod() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		CraftNoTaizaiModSounds.REGISTRY.register(bus);
		CraftNoTaizaiModBlocks.REGISTRY.register(bus);
		...
		CraftNoTaizaiModMenus.REGISTRY.register(bus);
