...
import net.mcreator.craftnotaizai.network.DemonClanButtonMessage;
...
public class DemonClanScreen extends AbstractContainerScreen<DemonClanMenu> {
	private final static HashMap<String, Object> guistate = DemonClanMenu.guistate;
	...
	public DemonClanScreen(DemonClanMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("craft_no_taizai:textures/screens/demon_clan.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.craft_no_taizai.demon_clan.label_stats"), -80, -35, -6750055, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.craft_no_taizai.demon_clan.label_30_health"), -84, -24, -1, false);
