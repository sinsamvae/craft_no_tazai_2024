...
public class GaintClanScreen extends AbstractContainerScreen<GaintClanMenu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("craft_no_taizai:textures/screens/image_1.png"), this.leftPos + -96, this.topPos + -78, 0, 0, 50, 50, 50, 50);

		guiGraphics.blit(new ResourceLocation("craft_no_taizai:textures/screens/gaintbar.png"), this.leftPos + -42, this.topPos + -84, 0, 0, 115, 33, 115, 33);

		guiGraphics.blit(new ResourceLocation("craft_no_taizai:textures/screens/giant.png"), this.leftPos + -24, this.topPos + -83, 0, 0, 79, 34, 79, 34);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.craft_no_taizai.gaint_clan.label_stats"), -85, -33, -26368, false);
		...
		guiGraphics.drawString(this.font, Component.translatable("gui.craft_no_taizai.gaint_clan.label_magic"), -83, 33, -26368, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.craft_no_taizai.gaint_clan.label_random_200_to_500"), -84, 50, -1, false);
	}
	...
	public void init() {
		...
		imagebutton_select = new ImageButton(this.leftPos + -34, this.topPos + 82, 48, 16, 0, 0, 16, new ResourceLocation("craft_no_taizai:textures/screens/atlas/imagebutton_select.png"), 48, 32, e -> {
			if (true) {
