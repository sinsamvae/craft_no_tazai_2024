...
import net.mcreator.craftnotaizai.network.KingDisasterButtonMessage;
...
public class KingDisasterScreen extends AbstractContainerScreen<KingDisasterMenu> {
	private final static HashMap<String, Object> guistate = KingDisasterMenu.guistate;
	...
	public KingDisasterScreen(KingDisasterMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("craft_no_taizai:textures/screens/king_disaster.png");
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + -115 && mouseX < leftPos + -91 && mouseY > topPos + -42 && mouseY < topPos + -18)
			guiGraphics.renderTooltip(font, Component.translatable("gui.craft_no_taizai.king_disaster.tooltip_reset"), mouseX, mouseY);
	}
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, Component.translatable("gui.craft_no_taizai.king_disaster.label_slot"), 42, 78, -1, false);
		guiGraphics.drawString(this.font,

				DisplaySlotProcedure.execute(entity), 26, 65, -1, false);
		guiGraphics.drawString(this.font,

				DisasterSkillDisplay1Procedure.execute(entity), -79, -44, -1, false);
		guiGraphics.drawString(this.font,

				DisasterSkillDisplay2Procedure.execute(entity), -79, -31, -1, false);
		guiGraphics.drawString(this.font,
		...
		guiGraphics.drawString(this.font,
				...
				DisasterSkillDisplay5Procedure.execute(entity), -79, 11, -1, false);
		guiGraphics.drawString(this.font,
	...
	public void init() {
		...
		imagebutton_plusbuttonmagic = new ImageButton(this.leftPos + -88, this.topPos + -42, 7, 7, 0, 0, 7, new ResourceLocation("craft_no_taizai:textures/screens/atlas/imagebutton_plusbuttonmagic.png"), 7, 14, e -> {
			if (true) {
				CraftNoTaizaiMod.PACKET_HANDLER.sendToServer(new KingDisasterButtonMessage(0, x, y, z));
				KingDisasterButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_plusbuttonover = new ImageButton(this.leftPos + -88, this.topPos + -29, 7, 7, 0, 0, 7, new ResourceLocation("craft_no_taizai:textures/screens/atlas/imagebutton_plusbuttonover.png"), 7, 14, e -> {
			if (true) {
				CraftNoTaizaiMod.PACKET_HANDLER.sendToServer(new KingDisasterButtonMessage(1, x, y, z));
				KingDisasterButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
		...
		imagebutton_plusbuttonover1 = new ImageButton(this.leftPos + -88, this.topPos + -15, 7, 7, 0, 0, 7, new ResourceLocation("craft_no_taizai:textures/screens/atlas/imagebutton_plusbuttonover1.png"), 7, 14, e -> {
			if (true) {
				CraftNoTaizaiMod.PACKET_HANDLER.sendToServer(new KingDisasterButtonMessage(2, x, y, z));
				KingDisasterButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		});
		...
		imagebutton_plusbuttonover2 = new ImageButton(this.leftPos + -88, this.topPos + -1, 7, 7, 0, 0, 7, new ResourceLocation("craft_no_taizai:textures/screens/atlas/imagebutton_plusbuttonover2.png"), 7, 14, e -> {
			if (true) {
				CraftNoTaizaiMod.PACKET_HANDLER.sendToServer(new KingDisasterButtonMessage(3, x, y, z));
				KingDisasterButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		});
		...
		imagebutton_plusbuttonover3 = new ImageButton(this.leftPos + -88, this.topPos + 13, 7, 7, 0, 0, 7, new ResourceLocation("craft_no_taizai:textures/screens/atlas/imagebutton_plusbuttonover3.png"), 7, 14, e -> {
			if (true) {
				CraftNoTaizaiMod.PACKET_HANDLER.sendToServer(new KingDisasterButtonMessage(4, x, y, z));
				KingDisasterButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		});
		...
		imagebutton_plusbuttonover4 = new ImageButton(this.leftPos + -88, this.topPos + 27, 7, 7, 0, 0, 7, new ResourceLocation("craft_no_taizai:textures/screens/atlas/imagebutton_plusbuttonover4.png"), 7, 14, e -> {
			if (true) {
				CraftNoTaizaiMod.PACKET_HANDLER.sendToServer(new KingDisasterButtonMessage(5, x, y, z));
				KingDisasterButtonMessage.handleButtonAction(entity, 5, x, y, z);
			}
		});
		...
		imagebutton_plusbuttonover5 = new ImageButton(this.leftPos + -88, this.topPos + 41, 7, 7, 0, 0, 7, new ResourceLocation("craft_no_taizai:textures/screens/atlas/imagebutton_plusbuttonover5.png"), 7, 14, e -> {
			if (true) {
				CraftNoTaizaiMod.PACKET_HANDLER.sendToServer(new KingDisasterButtonMessage(6, x, y, z));
				KingDisasterButtonMessage.handleButtonAction(entity, 6, x, y, z);
			}
		});
		...
		imagebutton_plusbuttonover6 = new ImageButton(this.leftPos + -88, this.topPos + 55, 7, 7, 0, 0, 7, new ResourceLocation("craft_no_taizai:textures/screens/atlas/imagebutton_plusbuttonover6.png"), 7, 14, e -> {
			if (true) {
				CraftNoTaizaiMod.PACKET_HANDLER.sendToServer(new KingDisasterButtonMessage(7, x, y, z));
				KingDisasterButtonMessage.handleButtonAction(entity, 7, x, y, z);
			}
		});
		...
		imagebutton_slot = new ImageButton(this.leftPos + 23, this.topPos + 75, 64, 16, 0, 0, 16, new ResourceLocation("craft_no_taizai:textures/screens/atlas/imagebutton_slot.png"), 64, 32, e -> {
			if (true) {
				CraftNoTaizaiMod.PACKET_HANDLER.sendToServer(new KingDisasterButtonMessage(8, x, y, z));
				KingDisasterButtonMessage.handleButtonAction(entity, 8, x, y, z);
			}
		});
		...
		imagebutton_restart = new ImageButton(this.leftPos + -115, this.topPos + -47, 20, 20, 0, 0, 20, new ResourceLocation("craft_no_taizai:textures/screens/atlas/imagebutton_restart.png"), 20, 40, e -> {
			if (true) {
				CraftNoTaizaiMod.PACKET_HANDLER.sendToServer(new KingDisasterButtonMessage(9, x, y, z));
				KingDisasterButtonMessage.handleButtonAction(entity, 9, x, y, z);
			}
		});
