...
public class CruelSunProjectileRenderer extends EntityRenderer<CruelSunProjectileEntity> {
	...
	@Override
	public void render(CruelSunProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(CruelSunProjectileEntity entity) {
		return texture;
	}
}
