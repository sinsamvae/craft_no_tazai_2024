...
import net.mcreator.craftnotaizai.procedures.EarthspikeOnEntityTickUpdateProcedure;
...
public class EarthspikeEntity extends Monster {
	public EarthspikeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CraftNoTaizaiModEntities.EARTHSPIKE.get(), world);
	}
	...
	public void baseTick() {
		super.baseTick();
		EarthspikeOnEntityTickUpdateProcedure.execute(this.level(), this);
	}
