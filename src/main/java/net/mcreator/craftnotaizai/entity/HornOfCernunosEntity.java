...
public class HornOfCernunosEntity extends Monster {
	public HornOfCernunosEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CraftNoTaizaiModEntities.HORN_OF_CERNUNOS.get(), world);
	}

	public HornOfCernunosEntity(EntityType<HornOfCernunosEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
