...
public class TrollEntity extends PathfinderMob implements GeoEntity {
	...
	public TrollEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CraftNoTaizaiModEntities.TROLL.get(), world);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(CraftNoTaizaiModItems.TROLL_EAR.get()));
	}
	...
	public static void init() {
		SpawnPlacements.register(CraftNoTaizaiModEntities.TROLL.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
