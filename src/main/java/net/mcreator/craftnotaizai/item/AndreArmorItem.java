...
public abstract class AndreArmorItem extends ArmorItem {
	public AndreArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends AndreArmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/andre.png";
		}
	}

	public static class Leggings extends AndreArmorItem {
		public Leggings() {
