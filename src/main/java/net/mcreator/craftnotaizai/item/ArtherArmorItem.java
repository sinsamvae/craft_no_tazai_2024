...
public abstract class ArtherArmorItem extends ArmorItem {
	public ArtherArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends ArtherArmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/arthurarmor.png";
		}
	}

	public static class Leggings extends ArtherArmorItem {
		public Leggings() {
