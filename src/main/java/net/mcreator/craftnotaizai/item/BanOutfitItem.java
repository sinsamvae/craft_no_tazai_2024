...
public abstract class BanOutfitItem extends ArmorItem {
	public BanOutfitItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public int getDefenseForType(ArmorItem.Type type) {
				return new int[]{3, 5, 8, 2}[type.getSlot().getIndex()];
			}
	...
	public static class Helmet extends BanOutfitItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/banoutfit.png";
		}
	}

	public static class Chestplate extends BanOutfitItem {
		public Chestplate() {
	...
	public static class Leggings extends BanOutfitItem {
		public Leggings() {
