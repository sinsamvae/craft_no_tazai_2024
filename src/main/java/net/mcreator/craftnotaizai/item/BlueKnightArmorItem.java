...
public abstract class BlueKnightArmorItem extends ArmorItem {
	public BlueKnightArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends BlueKnightArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/blue.png";
		}
	}

	public static class Chestplate extends BlueKnightArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends BlueKnightArmorItem {
		public Leggings() {
