...
public abstract class BoarHatOutfitItem extends ArmorItem {
	public BoarHatOutfitItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends BoarHatOutfitItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/boar_hat_outfit.png";
		}
	}

	public static class Leggings extends BoarHatOutfitItem {
		public Leggings() {
