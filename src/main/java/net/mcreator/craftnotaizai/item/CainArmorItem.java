...
public abstract class CainArmorItem extends ArmorItem {
	public CainArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends CainArmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/cain_armor.png";
		}
	}

	public static class Leggings extends CainArmorItem {
		public Leggings() {
