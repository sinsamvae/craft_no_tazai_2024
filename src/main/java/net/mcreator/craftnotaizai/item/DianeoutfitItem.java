...
public abstract class DianeoutfitItem extends ArmorItem {
	public DianeoutfitItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends DianeoutfitItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/dianeoutfit.png";
		}
	}

	public static class Leggings extends DianeoutfitItem {
		public Leggings() {
