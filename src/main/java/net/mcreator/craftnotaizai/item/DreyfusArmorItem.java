...
public abstract class DreyfusArmorItem extends ArmorItem {
	public DreyfusArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends DreyfusArmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/screenshot12-1529597835.png";
		}
	}

	public static class Leggings extends DreyfusArmorItem {
		public Leggings() {
