...
public abstract class FairyHelbramArmorItem extends ArmorItem {
	public FairyHelbramArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends FairyHelbramArmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/fairyhelbram.png";
		}
	}

	public static class Leggings extends FairyHelbramArmorItem {
		public Leggings() {
