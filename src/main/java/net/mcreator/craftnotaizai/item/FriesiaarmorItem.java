...
public abstract class FriesiaarmorItem extends ArmorItem {
	public FriesiaarmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends FriesiaarmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/friesia.png";
		}
	}

	public static class Chestplate extends FriesiaarmorItem {
		public Chestplate() {
	...
	public static class Leggings extends FriesiaarmorItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/models/armor/arthurarmor_layer_2.png";
		}
	}
}
