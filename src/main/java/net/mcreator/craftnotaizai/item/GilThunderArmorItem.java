...
public abstract class GilThunderArmorItem extends ArmorItem {
	public GilThunderArmorItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public int getDefenseForType(ArmorItem.Type type) {
				return new int[]{3, 5, 10, 0}[type.getSlot().getIndex()];
			}
	...
	public static class Chestplate extends GilThunderArmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/gilthunder_armor.png";
		}
	}

	public static class Leggings extends GilThunderArmorItem {
		public Leggings() {
