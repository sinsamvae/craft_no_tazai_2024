...
public abstract class GolgiusarmorItem extends ArmorItem {
	public GolgiusarmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends GolgiusarmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/2golgius.png";
		}
	}

	public static class Chestplate extends GolgiusarmorItem {
		public Chestplate() {
	...
	public static class Leggings extends GolgiusarmorItem {
		public Leggings() {
