...
public abstract class GowtherOutfitItem extends ArmorItem {
	public GowtherOutfitItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends GowtherOutfitItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/gowtheroutfit.png";
		}
	}

	public static class Leggings extends GowtherOutfitItem {
		public Leggings() {
