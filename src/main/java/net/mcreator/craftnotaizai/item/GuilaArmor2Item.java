...
public abstract class GuilaArmor2Item extends ArmorItem {
	public GuilaArmor2Item(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends GuilaArmor2Item {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/guila1.png";
		}
	}

	public static class Leggings extends GuilaArmor2Item {
		public Leggings() {
