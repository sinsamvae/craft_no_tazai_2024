...
public abstract class GuilaArmorItem extends ArmorItem {
	public GuilaArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends GuilaArmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/guilaarmor.png";
		}
	}

	public static class Leggings extends GuilaArmorItem {
		public Leggings() {
