...
public abstract class HelbrumArmorItem extends ArmorItem {
	public HelbrumArmorItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public int getDefenseForType(ArmorItem.Type type) {
				return new int[]{0, 5, 10, 0}[type.getSlot().getIndex()];
			}
	...
	public static class Chestplate extends HelbrumArmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/helbrum_armor.png";
		}
	}

	public static class Leggings extends HelbrumArmorItem {
		public Leggings() {
			...
			consumer.accept(new IClientItemExtensions() {
				...
				public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
					HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
							Map.of("left_leg", new Modelhelbrum_armor(Minecraft.getInstance().getEntityModels().bakeLayer(Modelhelbrum_armor.LAYER_LOCATION)).LeftLeg, "right_leg",
									new Modelhelbrum_armor(Minecraft.getInstance().getEntityModels().bakeLayer(Modelhelbrum_armor.LAYER_LOCATION)).RightLeg, "head", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "hat",
