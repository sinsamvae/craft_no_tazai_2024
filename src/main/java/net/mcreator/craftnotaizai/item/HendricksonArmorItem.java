...
public abstract class HendricksonArmorItem extends ArmorItem {
	public HendricksonArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends HendricksonArmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/sir_hendrickson.png";
		}
	}

	public static class Leggings extends HendricksonArmorItem {
		public Leggings() {
