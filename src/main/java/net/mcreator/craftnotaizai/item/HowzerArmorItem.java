...
public abstract class HowzerArmorItem extends ArmorItem {
	public HowzerArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends HowzerArmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/howzer.png";
		}
	}

	public static class Leggings extends HowzerArmorItem {
		public Leggings() {
