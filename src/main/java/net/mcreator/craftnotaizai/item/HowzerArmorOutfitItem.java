...
public abstract class HowzerArmorOutfitItem extends ArmorItem {
	public HowzerArmorOutfitItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public int getDefenseForType(ArmorItem.Type type) {
				return new int[]{2, 5, 10, 5}[type.getSlot().getIndex()];
			}
	...
	public static class Chestplate extends HowzerArmorOutfitItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/howzer_outfit.png";
		}
	}

	public static class Leggings extends HowzerArmorOutfitItem {
		public Leggings() {
