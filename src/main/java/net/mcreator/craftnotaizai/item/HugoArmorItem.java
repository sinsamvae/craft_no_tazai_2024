...
public abstract class HugoArmorItem extends ArmorItem {
	public HugoArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends HugoArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/hugo2.png";
		}
	}

	public static class Chestplate extends HugoArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends HugoArmorItem {
		public Leggings() {
