...
public abstract class JerichoItem extends ArmorItem {
	public JerichoItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends JerichoItem {
		public Chestplate() {
	...
	public static class Leggings extends JerichoItem {
		public Leggings() {
