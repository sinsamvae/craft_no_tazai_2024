...
public abstract class JerichoarmorItem extends ArmorItem {
	public JerichoarmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends JerichoarmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/jerichoarmor.png";
		}
	}

	public static class Leggings extends JerichoarmorItem {
		public Leggings() {
