...
public abstract class JillianArmorItem extends ArmorItem {
	public JillianArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends JillianArmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/jillian_armor.png";
		}
	}

	public static class Leggings extends JillianArmorItem {
		public Leggings() {
