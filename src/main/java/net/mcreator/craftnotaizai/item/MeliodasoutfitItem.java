...
public abstract class MeliodasoutfitItem extends ArmorItem {
	public MeliodasoutfitItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends MeliodasoutfitItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/meliodasoutfit.png";
		}
	}

	public static class Leggings extends MeliodasoutfitItem {
		public Leggings() {
