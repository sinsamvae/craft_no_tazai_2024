...
public abstract class MerlinOutfitItem extends ArmorItem {
	public MerlinOutfitItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends MerlinOutfitItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/merlinoutfit.png";
		}
	}

	public static class Leggings extends MerlinOutfitItem {
		public Leggings() {
