...
public abstract class MuramoArmorItem extends ArmorItem {
	public MuramoArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends MuramoArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/muramo_armor.png";
		}
	}

	public static class Chestplate extends MuramoArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends MuramoArmorItem {
		public Leggings() {
