...
public abstract class ParadaArmorItem extends ArmorItem {
	public ParadaArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends ParadaArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/parada_armor.png";
		}
	}

	public static class Chestplate extends ParadaArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends ParadaArmorItem {
		public Leggings() {
