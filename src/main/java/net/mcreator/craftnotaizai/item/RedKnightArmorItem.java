...
public abstract class RedKnightArmorItem extends ArmorItem {
	public RedKnightArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends RedKnightArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/redknight.png";
		}
	}

	public static class Chestplate extends RedKnightArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends RedKnightArmorItem {
		public Leggings() {
