...
public abstract class RoyalknightItem extends ArmorItem {
	public RoyalknightItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends RoyalknightItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/royal.png";
		}
	}

	public static class Chestplate extends RoyalknightItem {
		public Chestplate() {
	...
	public static class Leggings extends RoyalknightItem {
		public Leggings() {
		...
		public void initializeClient(Consumer<IClientItemExtensions> consumer) {
			consumer.accept(new IClientItemExtensions() {
				...
				public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
					HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
							Map.of("left_leg", new Modelhowzer_armor(Minecraft.getInstance().getEntityModels().bakeLayer(Modelhowzer_armor.LAYER_LOCATION)).LeftLeg, "right_leg",
									new Modelhowzer_armor(Minecraft.getInstance().getEntityModels().bakeLayer(Modelhowzer_armor.LAYER_LOCATION)).RightLeg, "head", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "hat",
