...
public abstract class RuinArmorItem extends ArmorItem {
	public RuinArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends RuinArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/2ruin.png";
		}
	}

	public static class Chestplate extends RuinArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends RuinArmorItem {
		public Leggings() {
