...
public abstract class SimonArmorItem extends ArmorItem {
	public SimonArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends SimonArmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/simon_armor.png";
		}
	}

	public static class Leggings extends SimonArmorItem {
		public Leggings() {
