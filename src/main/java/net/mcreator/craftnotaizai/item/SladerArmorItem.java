...
public abstract class SladerArmorItem extends ArmorItem {
	public SladerArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends SladerArmorItem {
		public Helmet() {
	...
	public static class Chestplate extends SladerArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends SladerArmorItem {
		public Leggings() {
