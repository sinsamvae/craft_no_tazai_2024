...
public abstract class TwigoArmorItem extends ArmorItem {
	public TwigoArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends TwigoArmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/twigo3.png";
		}
	}

	public static class Leggings extends TwigoArmorItem {
		public Leggings() {
