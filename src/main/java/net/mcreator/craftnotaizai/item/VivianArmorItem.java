...
public abstract class VivianArmorItem extends ArmorItem {
	public VivianArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends VivianArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/vivian.png";
		}
	}

	public static class Chestplate extends VivianArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends VivianArmorItem {
		public Leggings() {
