...
public abstract class WeinheidtArmorItem extends ArmorItem {
	public WeinheidtArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends WeinheidtArmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/weinheidt_armor2.png";
		}
	}

	public static class Leggings extends WeinheidtArmorItem {
		public Leggings() {
