...
public class ChangemagicFullCounterProcedure {
	public static void execute(CommandContext<CommandSourceStack> arguments) {
		{
			String _setval = "Full_Counter";
			(new Object() {
		...
		}.getEntity()).getPersistentData().putString("Ability1", "Full Counter");
		(new Object() {
			public Entity getEntity() {
				try {
					return EntityArgument.getEntity(arguments, "Player");
		...
		}.getEntity()).getPersistentData().putString("Ability2", "Revenge Counter");
		(new Object() {
			public Entity getEntity() {
				try {
					return EntityArgument.getEntity(arguments, "Player");
		...
		}.getEntity()).getPersistentData().putString("Ability3", "Demon Mark");
		(new Object() {
			public Entity getEntity() {
				try {
					return EntityArgument.getEntity(arguments, "Player");
		...
		}.getEntity()).getPersistentData().putString("Ability4", "Berserk Mode");
		(new Object() {
			public Entity getEntity() {
				try {
					return EntityArgument.getEntity(arguments, "Player");
