...
public class DaichiNoKibaWhileProjectileFlyingTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity immediatesourceentity) {
		...
		for (int index0 = 0; index0 < (int) (entity.getPersistentData().getDouble("range") * 5); index0++) {
			...
			CraftNoTaizaiMod.queueServerWork((int) delay, () -> {
				...
				CraftNoTaizaiMod.queueServerWork(50, () -> {
					if (world instanceof ServerLevel _level) {
						Entity entityToSpawn = CraftNoTaizaiModEntities.EARTHSPIKE.get().spawn(_level, new BlockPos(world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) x, (int) z),
								world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) x, (int) z), world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) x, (int) z)), MobSpawnType.MOB_SUMMONED);
