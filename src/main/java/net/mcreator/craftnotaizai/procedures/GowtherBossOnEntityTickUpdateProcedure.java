...
public class GowtherBossOnEntityTickUpdateProcedure {
							...
							if (!projectileLevel.isClientSide()) {
								Projectile _entityToSpawn = new Object() {
									public Projectile getArrow(Level level, Entity shooter, float damage, int knockback) {
										AbstractArrow entityToSpawn = new KillSwitchProjectileEntity(CraftNoTaizaiModEntities.KILL_SWITCH_PROJECTILE.get(), level);
