...
public class KingDisasterMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public KingDisasterMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(CraftNoTaizaiModMenus.KING_DISASTER.get(), id);
